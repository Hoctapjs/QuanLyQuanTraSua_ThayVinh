...
--============
	...
	*/
	...
	INSERT INTO DONHANG (MADH, MAKH, MANV, NGAYDH, TONGTIEN)
	VALUES ('DH0012', 'KH0004', 'NV0004', '2024-08-09', NULL);

	INSERT INTO DONHANG (MADH, MAKH, MANV, NGAYDH, TONGTIEN)
	VALUES ('DH0013', 'KH0021', 'NV0004', '2024-08-09', NULL);

	INSERT INTO DONHANG (MADH, MAKH, MANV, NGAYDH, TONGTIEN)
	VALUES ('DH0014', 'KH0007', 'NV0004', '2024-08-09', NULL);
	...
	INSERT INTO CHITIETDONHANG (MADH, MASP, MANV, SOLUONG, GIA)
	VALUES ('DH0013', 'SP0010', 'NV0004', 5, NULL);

	INSERT INTO CHITIETDONHANG (MADH, MASP, MANV, SOLUONG, GIA)
	VALUES ('DH0014', 'SP0010', 'NV0004', 5, NULL);

	INSERT INTO CHITIETDONHANG (MADH, MASP, MANV, SOLUONG, GIA)
	VALUES ('DH0002', 'SP0008', 'NV0010', 5, NULL);

	INSERT INTO CHITIETDONHANG (MADH, MASP, MANV, SOLUONG, GIA)
	VALUES ('DH0011', 'SP0006', 'NV0006', 5, NULL);

	INSERT INTO CHITIETDONHANG (MADH, MASP, MANV, SOLUONG, GIA)
	VALUES ('DH0012', 'SP0007', 'NV0004', 5, NULL);
...
GO
	CREATE PROCEDURE CAPNHAT_USER_SESSSIONS_LOGOUT
	(
		@IsLoggedIn BIT,
		@UserID INT
	)
...
-- thủ tục khách hàng
	CREATE PROCEDURE TIM_KHACHHANG_BANG_MAKH 
	(
		@MAKH CHAR(6)
	)
	AS
		BEGIN
			SELECT * FROM KHACH WHERE MAKH = @MAKH
		END
GO
	EXEC TIM_KHACHHANG_BANG_MAKH 'KH0001'
GO

GO

	CREATE PROCEDURE TIM_KHACHHANG_BANG_TENKH
	(
		@TENKH NVARCHAR(50)
	)
	AS
	BEGIN
		SELECT * FROM KHACH WHERE HOTEN LIKE N'%'+ @TENKH +'%'
	END
GO
	EXEC TIM_KHACHHANG_BANG_TENKH N'huỳnh' 
GO

SELECT * FROM KHACH WHERE HOTEN LIKE N'%huỳnh%'
GO
	CREATE PROCEDURE TIM_KHACHHANG_BANG_SODT 
	(
		@SODT NVARCHAR(20)
	)
	AS
		BEGIN
			SELECT * FROM KHACH WHERE SODIENTHOAI = @SODT
		END
GO
	EXEC TIM_KHACHHANG_BANG_SODT N'0912727532'
GO
	CREATE PROCEDURE SELECT_MA_KHACH_FROM_KHACH
	AS
		BEGIN
...
GO
	...
	AS
		...
		END
GO
-- end thủ tục khách hàng

-- THỦ TỤC 

-- cấp quyền create login từ sa cho tài khoản tạo login son
use QuanLyTraSuaDB2
GRANT EXECUTE ON OBJECT::[dbo].[CreateLogin] TO [son];
GRANT EXECUTE ON OBJECT::[dbo].[CreateUserForLogin] TO [son];
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.THEM_USER_MOI_DANGNHAPSQL TO son WITH GRANT OPTION;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LAY_USER_ID TO son WITH GRANT OPTION;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LOGIN_CHECK_QUERY_DANGNHAPSQL TO son WITH GRANT OPTION;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LOGIN_INSERT_QUERY_DANGNHAPSQL TO son WITH GRANT OPTION;
...
GRANT SELECT, UPDATE ON Users_ID_Store TO son WITH GRANT OPTION;
GRANT SELECT, UPDATE ON UserSessions TO son WITH GRANT OPTION;
...
-- cấp quyền từ tài khoản son cho tài khoản mới được tạo
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.THEM_USER_MOI_DANGNHAPSQL TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.LAY_USER_ID TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.LOGIN_CHECK_QUERY_DANGNHAPSQL TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.LOGIN_INSERT_QUERY_DANGNHAPSQL TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.LOGIN_UPDATE_QUERY_DANGNHAPSQL TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.LOGOUT_UPDATE_QUERY_DANGNHAPSQL TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.IsUserLoggedIn_DANGNHAPSQL TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.LAY_MASP_TU_SP_SANPHAM TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.XEM_BANG_SANPHAM TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.XEM_BANG_KHACH TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.SELECT_MA_KHACH_FROM_KHACH TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.TIM_DONHANG_TU_MAKHACH TO NV0002;
GRANT EXECUTE ON QuanLyTraSuaDB2.dbo.CAPNHAT_USER_SESSSIONS_LOGOUT TO NV0002;
GRANT SELECT ON Users_ID_Store TO NV0002;
GRANT SELECT ON UserSessions TO NV0002;
GRANT UPDATE ON UserSessions TO NV0002;
GRANT SELECT, UPDATE ON Users_ID_Store TO NV0002;

-- tạm kết phần gán quyền

-- bắt đầu thủ tục tính tiền
GO
	-- THỦ TỤC TÍNH TIỀN CÁC SẢN PHẨM TRONG CHI TIẾT ĐƠN HÀNG
	CREATE PROCEDURE TinhVaCapNhatGiaChiTietDonHang
	(
		@MADH CHAR(6),
		@MASP CHAR(6),
		@SOLUONG INT
	...
	BEGIN
		...
		-- Lấy giá bán của sản phẩm từ bảng SANPHAM
		SELECT @GIABAN = GIABAN
		FROM SANPHAM
		WHERE MASP = @MASP;

		-- Tính tổng giá dựa trên số lượng và giá bán
		SET @GIA = @GIABAN * @SOLUONG;

		-- Cập nhật giá vào bảng CHITIETDONHANG
		UPDATE CHITIETDONHANG
		SET GIA = @GIA
		WHERE MADH = @MADH AND MASP = @MASP;

		-- Trả về tổng giá trị đã tính
		SELECT @GIA AS GIA_TRI_TINH_DUOC;
	END
GO
/* 	DROP PROCEDURE TinhVaCapNhatGiaChiTietDonHang*/
	SELECT * FROM CHITIETDONHANG
	SELECT * FROM SANPHAM

	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0001', 'SP0001', '2'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0001', 'SP0004', '2'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0003', 'SP0001', '3'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0004', 'SP0002', '1'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0004', 'SP0005', '4'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0005', 'SP0007', '2'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0006', 'SP0005', '4'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0007', 'SP0008', '4'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0008', 'SP0009', '3'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0009', 'SP0006', '2'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0010', 'SP0006', '5'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0010', 'SP0010', '5'
	EXEC TinhVaCapNhatGiaChiTietDonHang 'DH0013', 'SP0010', '5'
GO
	-- THỦ TỤC TÍNH TỔNG TIỀN CHO ĐƠN HÀNG
	CREATE PROCEDURE TinhTongTienDonHang
	(
		@MADH CHAR(6)
	)
	AS
...
GO
	SELECT * FROM DONHANG
	EXEC TinhTongTienDonHang 'DH0001'
	EXEC TinhTongTienDonHang 'DH0002'
	EXEC TinhTongTienDonHang 'DH0003'
	EXEC TinhTongTienDonHang 'DH0004'
	EXEC TinhTongTienDonHang 'DH0005'
	EXEC TinhTongTienDonHang 'DH0006'
	EXEC TinhTongTienDonHang 'DH0007'
	EXEC TinhTongTienDonHang 'DH0008'
	EXEC TinhTongTienDonHang 'DH0009'
	EXEC TinhTongTienDonHang 'DH0010'
	EXEC TinhTongTienDonHang 'DH0011'
	EXEC TinhTongTienDonHang 'DH0012'
	EXEC TinhTongTienDonHang 'DH0013'
GO
use QuanLyTraSuaDB2
GO
	-- TRIGGER CHI TIẾT ĐƠN HÀNG
		-- TRIGGER TÍNH GIA
			...
			BEGIN
				...
				SELECT @MADH = i.MADH, @MASP = i.MASP, @SOLUONG = i.SOLUONG
				FROM Inserted i;
	...
	-- TRIGGER ĐƠN HÀNG'
		-- TRIGGER TÍNH TONGTIEN
			...
			BEGIN
				...
				BEGIN
					SELECT TOP 1 @MADH = i.MADH
					FROM Inserted i;
				END
				ELSE IF EXISTS (SELECT 1 FROM Deleted)
				BEGIN
					SELECT TOP 1 @MADH = d.MADH
					FROM Deleted d;
				END
...
-- cấp quyền create login từ sa cho tài khoản tạo login son, và cấp quyền cho son có thể gán các quyền cơ bản cho user
	...
	-- quyền cho khách hàng
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_BANG_KHACH TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.SELECT_MA_KHACH_FROM_KHACH TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_KHACHHANG_BANG_SODT TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_KHACHHANG_BANG_TENKH TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_KHACHHANG_BANG_MAKH TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_DONHANG_TU_MAKHACH  TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.UpdateKhach TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.DeleteKhach TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.InsertKhach TO son WITH GRANT OPTION;
	-- quyền cho đơn hàng
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_VIEW_DONHANG TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LAY_MADH_TU_DH_DONHANG TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.InsertDonHang TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.DeleteDonHang TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_VIEW_DONHANG TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.UpdateDonHang  TO son WITH GRANT OPTION;
	-- quyền cho chi tiết đơn hàng
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_VIEW_CHITIETDONHANG TO son WITH GRANT OPTION;
		GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LAY_MADH_MASP_TU_V_CHITIETDONHANG TO son WITH GRANT OPTION;
	...
	GRANT SELECT, UPDATE ON Users_ID_Store TO son WITH GRANT OPTION;
	GRANT SELECT, UPDATE ON UserSessions TO son WITH GRANT OPTION;
	GRANT SELECT, INSERT, UPDATE ON KHACH TO son WITH GRANT OPTION;
	GRANT SELECT, INSERT, UPDATE ON DONHANG TO son WITH GRANT OPTION;
	GRANT SELECT, INSERT, UPDATE ON CHITIETDONHANG TO son WITH GRANT OPTION;
...
-- sơn gán quyền cho khách
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_BANG_KHACH TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.SELECT_MA_KHACH_FROM_KHACH TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_KHACHHANG_BANG_SODT TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_KHACHHANG_BANG_TENKH TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_KHACHHANG_BANG_MAKH TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.TIM_DONHANG_TU_MAKHACH  TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.UpdateKhach TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.DeleteKhach TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.InsertKhach TO son;
-- sơn gán quyền cho đơn hàng
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_VIEW_DONHANG TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LAY_MADH_TU_DH_DONHANG TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.InsertDonHang TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.DeleteDonHang TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_VIEW_DONHANG TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.UpdateDonHang  TO son;
-- sơn gán quyền cho chi tiết đơn hàng
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.XEM_VIEW_CHITIETDONHANG TO son;
GRANT EXECUTE ON OBJECT::QuanLyTraSuaDB2.dbo.LAY_MADH_MASP_TU_V_CHITIETDONHANG TO son;
